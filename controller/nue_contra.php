...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($_POST['cont'] == "" || $_POST['conta'] == "") {
        ...
        echo '<script>window.location="../public/usuario/recupe.html"</script>';
    } else {
        ...
        echo '<script>window.location="../public/usuario/index.php"</script>';
    }
}
?>
...
<div class="login-container">
            ...
            <div class="col-md-12 form-left">
                <form method="POST" name="form1" id="form1" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <a href="../public/usuario/index.php" class="btn btn-primary px-5">Volver </a>
                    </div>
                </form>
            </div>
        </div>
    ...
    else
    {
        ...
        echo '<script>window.location="../public/usuario/recuperacion.html"</script>';
    }
}
