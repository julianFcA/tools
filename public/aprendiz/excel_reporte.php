...
if ($result->num_rows > 0) {
    $sheet->setCellValue('A1', 'Reporte de aprendiz');
    $sheet->mergeCells('A1:O1');
    $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(14);
    $sheet->getStyle('A1')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

    $headers = ['Nombre', 'Apellido', 'Tipo de documento', 'Documento', 'Formación', 'Ficha', 'Jornada', 'Herramienta','N° De Prestamo', 'Fecha de Adquisición' , 'Días', 'Fecha de Entrega',  'Estado de Prestamo','Cantidad Adquirida', 'Descripcion'];
...
$filename = 'reporte_aprendiz.xlsx';
