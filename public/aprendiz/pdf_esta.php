...
if ($result->num_rows > 0) {
    ...
    $html = '<html><head><title>Estado de Aprendiz</title>';
    $html .= '<style>
    ...
    $html .= '</head><body>';
    $html .= '<h1>Estado de Aprendiz</h1>';

    // Crea una variable para almacenar el HTML de la tabla
    $html .= '<table><thead><tr><th>Nombre Aprendiz</th><th>Apellido Aprendiz</th><th>Tipo de Documento</th><th>Documento</th><th>Formacion</th><th>Ficha</th><th>Jornada</th><th>Herramienta</th><th>N° de prestamo</th><th>Fecha de Adquisición</th><th>Fecha de Entrega</th><th>Dias de Prestamo</th><th>Estado de Prestamo</th><th>Cantidad devuelta</th></tr></thead><tbody>';
    ...
    $html2pdf->output('estado_prestamos_aprendiz.pdf', 'D');
} else {
