...
if ($result->num_rows > 0) {
    ...
    $html = '<html><head><title>Prestamos de Aprendiz</title>';
    $html .= '<style>
    ...
    $html .= '</head><body>';
    $html .= '<h1>Prestamos de Aprendiz</h1>';

    // Crea una variable para almacenar el HTML de la tabla
    $html .= '<table><thead><tr><th>Nombre Aprendiz</th><th>Apellido Aprendiz</th><th>Tipo de Documento</th><th>Documento</th><th>Formacion</th><th>Ficha</th><th>Jornada</th><th>Herramienta</th><th>Fecha de Adquisición</th><th>Dias de Prestamo</th><th>Fecha de Entrega</th></tr></thead><tbody>';
    ...
    $html2pdf->output('prestamos_aprendiz.pdf', 'D');
} else {
