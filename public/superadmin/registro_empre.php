...
$consulta2 = $conn->prepare("SELECT nom_tp_docu FROM tp_docu WHERE id_tp_docu >= 2 ");
$consulta2->execute();
    ...
    <div class="registro_container">
            ...
            <form class="registro_form" action="../controller/RegisterController.php" name="formRegister" autocomplete="off" method="POST" class="formulario">
                ...
                <div class="form-group">
                    <label for="tp_docu">Tipo de Documento</label>
                    <select class="form-control" name="tp_docu" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Ingrese nombre" class="form-control" name="apellido" title="Debe ser de 15 letras" required oninput="validarLetras(this)" minlength="6" maxlength="12">
                </div> 
                ...
                <input type="hidden" placeholder="Estado" readonly class="form-control" value="2" name="id_esta_usu">
                <input type="hidden" placeholder="rol" readonly class="form-control" value="2" name="id_rol">
