...
if ($result->num_rows > 0) {
    // Añadir un título
    $sheet->setCellValue('A1', 'Ingreso de Instructores');
    $sheet->mergeCells('A1:H1'); // Ajustar el rango según el número de columnas
    $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(14);
    $sheet->getStyle('A1')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
    
    // Encabezados personalizados de columna
    $headers = ['Nombre', 'Apellido', 'Tipo de documento', 'Número de Identificación', 'Formación', 'Ficha', 'Jornada', 'Último Ingreso'];
...
$filename = 'ingreso_instructores.xlsx';
