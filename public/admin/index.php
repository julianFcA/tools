...
$query = "SELECT empresa.nit_empre, empresa.nom_empre, empresa.direcc_empre, empresa.telefono, empresa.correo_empre, licencia.fecha_ini, licencia.fecha_fin, licencia.esta_licen, usuario.nombre, usuario.documento, usuario.correo, usuario.codigo_barras FROM empresa INNER JOIN licencia ON empresa.nit_empre = licencia.nit_empre LEFT JOIN usuario ON empresa.nit_empre = usuario.nit_empre  INNER JOIN rol ON usuario.id_rol = rol.id_rol WHERE empresa.nit_empre > 0 AND usuario.id_rol = 2";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav  ">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="./licencia.php"> Activar Licencia  </a>
                    </li>
                    <li class="nav-item">
                                    ...
                                    <tbody>
                                        <?php foreach ($resultado_pagina as $entrada) { ?>
                                            ...
                                            <tr class="<?= $estadoClase ?>" style="color: <?php echo $color; ?>">
                                                ...
                                                <td>
                                                    <form method="GET" action="elim_licen.php">
                                                        <input type="hidden" name="licencia" value="<?= $entrada["nit_empre"] ?>">
