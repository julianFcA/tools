                ...
                <tr>
                    ...
                    <td>
                        <form method="GET" action="asigna.php">
                            <input type="hidden" name="documento" value="${json_data.documento}">
                            <button class="btn btn-success" type="submit" name="asig">Asignar Formación</button>
                        </form>
                        <br>
                        <form method="GET" action="actu_instru.php">
                            <input type="hidden" name="documento" value="${json_data.documento}">
                            <button class="btn btn-primary" type="submit" name="actu">Actualizar Instructor</button>
                        </form>
                    </td>
                </tr>`;
            });
