                                            ...
                                            <div class="container my-4">
                                                <div class="row">
                                                    ...
                                                    <section class="d-flex align-items-center">
                                                        <div class="ml-3">
                                                            <a href="excel_instru.php" class="mr-2">
                                                                <img src="../../images/excel1.png" alt="Imagen 2" class="img-fluid" style="max-height: 30px;">
                                                            </a>
                                                            <a href="excel_instru.php" class="letra" style="font-size: 14px;">EXCEL</a>
                                                        </div>
                                                        <!-- Agregamos un espacio horizontal -->
                                                        <div style="width: 10px;"></div>
                                                        <div class="ml-3">
                                                            <a href="pdf_instru.php" class="mr-2">
                                                                <img src="../../images/pdf1.png" alt="Imagen 1" class="img-fluid" style="max-height: 30px;">
                                                            </a>
                                                            <a href="pdf_instru.php" class="letra" style="font-size: 14px;">PDF</a>
                                                        </div>
                                                    </section>
                                                </div>
                                            </div>
