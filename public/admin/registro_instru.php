...
$consulta = $conn->prepare("SELECT ficha.ficha, formacion.id_forma, formacion.nom_forma, jornada.id_jornada, jornada.tp_jornada FROM ficha INNER JOIN jornada ON ficha.id_jornada = jornada.id_jornada INNER JOIN formacion ON formacion.id_forma = ficha.id_forma WHERE ficha.ficha > 0 AND formacion.id_forma > 1 AND jornada.id_jornada > 1");
$consulta->execute();
