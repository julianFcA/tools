...
if ($result->num_rows > 0) {
    // Añadir un título
    $sheet->setCellValue('A1', 'Instructores');
    ...
    $headers = ['Nombre', 'Apellido', 'Tipo de documento', 'Numero de Identificación', 'Formación', 'Ficha', 'Jornada'];
...
$filename = 'reporte_instructores.xlsx';
